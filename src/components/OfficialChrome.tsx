      ...
      <div className="mx-auto grid max-w-[1440px] grid-cols-[1fr_auto_auto] items-center gap-3 px-4 py-3 sm:px-6 lg:grid-cols-[1fr_auto_1fr] lg:px-8">
        ...
        <nav className="hidden items-center gap-1 rounded-full border border-white/10 bg-white/[0.045] p-1 lg:flex">
          {primaryNav.map((item) => (
            <Link
              ...
              href={item.href}
              className={cn(
                "rounded-full px-3 py-2 text-xs font-black uppercase tracking-normal transition xl:px-4",
                item.live && "text-red-300 hover:bg-red-500 hover:text-white",
        ...
        <div className="hidden items-center justify-end gap-3 lg:flex">
          <div className="text-right">
            ...
            <div className="relative mt-1 h-10 w-36 overflow-hidden rounded-md border border-white/10 bg-white/[0.94] p-1.5 shadow-[0_0_22px_rgba(245,197,66,0.10)]">
              <Image src="/brand/arena-360.png" alt="Arena 360" fill sizes="144px" className="object-contain p-1" />
            </div>
          </div>
        </div>

        <div className="relative hidden h-9 w-28 rounded-md border border-white/10 bg-white/95 min-[390px]:block lg:hidden">
          <Image src="/brand/arena-360.png" alt="Arena 360" fill sizes="112px" className="object-contain p-1" />
        </div>
        ...
        <div className="border-t border-white/10 bg-black px-4 py-3 lg:hidden">
          <div className="mx-auto grid max-w-[1440px] gap-2">
            ...
            <div className="mt-1 flex items-center justify-between rounded-md border border-white/10 bg-white/[0.03] px-4 py-3">
              ...
              <div className="relative h-9 w-32 rounded bg-white/95">
                <Image src="/brand/arena-360.png" alt="Arena 360" fill sizes="128px" className="object-contain p-1" />
              </div>
            </div>
          </div>
        </div>
...
export function PremiumFooter() {
  return (
    <footer id="patrocinadores" className="border-t border-white/10 bg-black/60">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-4 px-4 py-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-2 opacity-90 min-[420px]:grid-cols-4 sm:grid-cols-8">
          {COURT_SPONSOR_LIST.map((sponsor) => (
            <div key={sponsor.groupId} className="relative h-12 overflow-hidden rounded-md border border-white/10 bg-white/[0.94] shadow-[0_0_18px_rgba(255,255,255,0.04)] sm:h-14">
