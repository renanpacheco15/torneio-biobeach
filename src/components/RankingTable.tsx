              ...
              return (
                <tr
                  ...
                  className={cn(
                    ...
                    row.classifying && "bg-emerald-50",
                    isHighlight && "bg-amber-50 outline outline-2 outline-amber-300",
                  )}
                >
                  <td className="px-3 py-3">
                    <div
                      className={cn(
                        ...
                        row.classifying ? "bg-emerald-600 text-white" : "bg-slate-100 text-slate-800",
                      )}
                    >
                      {row.position}
                    </div>
